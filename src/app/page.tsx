...
import { ComicResponse, getByIndex, getRandom } from "@/lib/xkcd";
...
export default async function Page(props: Props) {
  ...
  const comicNumber = parseInt(comicId, 10);
  ...
  try {
    ...
    return (
      <div className="flex flex-col justify-center items-center h-screen p-4 text-center">
        <h1 className="text-4xl font-bold text-gray-800 pb-2">XKCD #{comic.num}: {comic.title}</h1>
